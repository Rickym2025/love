...
import { Folder, PlusCircle, Palette, Sliders, Music, ExternalLink, X, Sparkles, Check } from "lucide-react";
...
export default function AgencyStudioPage({ params }: { params: { agencyId: string } }) {
  ...
  const [themeParty, setThemeParty] = useState-[#D4AF37]("Elegante in Abito da Sera");
  ...
  return (
    <div className="min-h-screen bg-[#FAF7F2] text-[#1E293B] flex flex-col md:flex-row font-sans">
      ...
      {/* ─── COLONNA 3: ANTEPRIMA LIVE REALE CON VERA CERALACCA E MODULI ─── */}
      <div className="flex-1 p-6 bg-[#1E293B] flex flex-col items-center justify-center">
        ...
        >
          {/* BUSTA D'EPOCA CON VERA CERALACCA LOGO public/wax-seal.png */}
          {modules.envelope && (
          ...
          {/* GRATTIAMO LA DATA (3 TILES TEMPLATE 2 O BOX GOLD TEMPLATE 1) */}
          {modules.scratchDate && (
          ...
          {/* PROGRAMMA DELLA GIORNATA COLORATO E DIVERTENTE */}
