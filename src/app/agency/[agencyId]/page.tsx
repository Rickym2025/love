...
export default function AgencyStudioPage({ params }: AgencyPageProps) {
  ...
  const [weddingsList] = useState([
    ...
    { id: "3", slug: "marco-e-sofia", couple: "Marco & Sofia", date: "04 Ottobre 2026", status: "Bozza", guests: 150, rsvps: 0 },
  ]);
  ...
  return (
    <div className="min-h-screen bg-[#FAF7F2] text-[#1E293B] flex flex-col md:flex-row select-none overflow-hidden">
      ...
      <div
        ...
        className="w-1.5 bg-slate-200 hover:bg-[#D4AF37] cursor-col-resize flex items-center justify-center transition-colors hidden md:flex"
      >
