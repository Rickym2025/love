...
export default function PartingClouds({
  ...
  return (
    <div className="relative py-20 overflow-hidden min-h-[500px] flex flex-col items-center justify-center">
      {/* NUVOLA SINISTRA */}
      <div
      ...
      {/* TIMELINE VERTICALE REALE TRA LE NUVOLE (Come Immagine Allegata) */}
