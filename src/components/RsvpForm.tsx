...
export default function RsvpForm({
  ...
  const colors = Array.isArray(paletteColors) && paletteColors.length > 0
    ? paletteColors
    : ["#FAF7F2", "#FFF0F5", "#FDE2E4", "#D4AF37", "#1E293B"];

  const mainAccent = colors[3] || "#D4AF37";
  const darkText = colors[4] || "#1E293B";
  const bgCard = colors[0] || "#FFFFFF";
  ...
  // MODELLO 2: SCHEDE CARD MODERNE CON ICONE ("moderno")
  ...
  // MODELLO 3: PASTELLO MINIMAL ("pastello")
  ...
  // MODELLO 1: CLASSICO ELEGANTE (DEFAULT / "classico")
  return (
    <form
      onSubmit={handleSubmit}
